...
<div class="container-fluid content-section">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 paddingleft">

            <h6 class="newfontcolor verdana"> DIHAS</h6>
          

            <div class="newfontcolor new_font_size new_line_height verdana"> Empowering <i
                    class="font_family_georgia">Families,</i><br>
                Continuing <i class="font_family_georgia">Legacies.</i></div>
            <br>

            <div class="newfontcolor new_line_height_2 verdana">
...
<br>
            <div class="new_background_color">
                <div class="row mb-3">
                    ...
                    <div class="col">
                        <h2 style="color:white; margin-left:40px;" class="verdana">About DIHAS</h2>
                    </div>
                    <div class="col">
                        <p id="myBtn_details" class="details d-flex justify-content-end know_more_font_size"
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-5">
                        <div class="card mb-4 position-relative">
                            <div class="card-body">
                                <h5 class="card-title text-muted  verdana ">Objective</h5>

                                <p class="card-text">

                                    <span class="verdana line_height change_font ">The objective of the scheme is to
                                        grant appointment on compassionate

                                        <span id="dots">......</span>
                                    </span>

                                    <span id="more" class="verdana">
                                    grounds to the next of kin
                                        ...
                                        the scheme shall not be admissible / extendable to dependent family member of a
                                        Government servant if the Government Servant was appointed under Die-in -harness
                                        Scheme (DIH).
                                    </span>

                                    <!-- Seema -->
                                <p id="myBtn">Know more</p>
                    ...
                    <div class="col-md-5">
                        <div class="card mb-3 position-relative">
                            <div class="card-body">
                                <h5 class="card-title text-muted  mb-2 verdana ">Benefits</h5>

                                <p class="card-text">


                                    <span class="verdana line_height change_font ">
                                        (a) The Scheme shall be applicable to unemployed dependent family member 


                                        <span id="dotsbenefits">......</span>
                                    </span>

                                    <span class="verdana" id="morebenefits">
                                    of the
                                        deceased Government
                                    ...
                                    <!-- Seema -->
                                <p id="myBtnbenefits" style="color:blue;">Know more</p>
        ...
        <div class="col-sm-4 paddingright">
            ...
            <div class="form-container">
                ...
                <form id="login-form" class="background">
                    <div class="card-body">
                        ...
                        <div class="row mb-1 mt-3">
                            ...
                            <div class="col-md-12">
                                <button type="button" class="btn btn-primary w-100 new_background_color" id="getOTPBtn">Get OTP</button>
                            </div>
                        ...
                        <div class="row mb-1 login-div2 mt-3" style="display: none;">
                            ...
                            <div class="row mb-3 justify-content-center marinleft">
                                <button type="button" class="btn btn-primary w-100 new_background_color" disabled id="loginBtn">
                                    Login
                                </button>
...
<br>
            ...
            <div id="register-form" class="form-container_department  displaynone background">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-1 mt-3">
                        ...
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary w-100 new_background_color" id="getOTPBtnDept">Get OTP</button>
                        </div>
                    ...
                    <div class="row mb-1 login-div3 mt-3" style="display: none;">
                        ...
                        <div class="row mb-3 justify-content-center marinleft">
                            ...
                            <button type="button" class="btn btn-primary w-100 new_background_color" id="loginBtnDept" disabled>
                                Login
                            </button>
    ...
    <div class=" row paddingleft paddingright">
        ...
        <hr>
        <div class="newfontcolor apply_font_size text-center"> <i class="font_family_georgia"> How to Apply</i><br>
        </div>
        <div class="text-center newfontcolor verdana">
        ...
        <div class="col card_padding">
            <div class="card card_width">
                <div class="card-body">
                    ...
                    <h5 class="card-title"> <i class="fa-solid fa-bars icon_color1"></i></h5>
                    <h6 class="card-subtitle mb-2  card1_color verdana">Fill Out General Details</h6>
                    <p class="card-text verdana">Applicant details information, address, post apply will be entered....</p>
        ...
        <div class="col card_padding">
            <div class="card card_width">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 card2_color verdana"> Details of the family</h6>
                    <p class="card-text verdana">All family members details excluding applicant will be entered....</p>
        ...
        <div class="col card_padding">
            <div class="card card_width">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 card3_color verdana">Uploading of Documents</h6>
                    <p class="card-text verdana">Required documents as per the scheme will be uploaded here....</p>
        ...
        <div class="col card_padding">
            <div class="card card_width">
                <div class="card-body">
                    ...
                    <h5 class="card-title">
                        <i class="fas fa-paper-plane icon_color4"></i>
                        <!-- <i class="fas fa-check-square"></i>  -->
                    </h5>
                    <h6 class="card-subtitle mb-2 card4_color verdana">Submission of the Application</h6>
                    <p class="card-text verdana">After filling and uploading all details application can be submitted....</p>
...
<div class="row paddingleft paddingright ">
    ...
    <div class="row new_background_color">

        <div class="col-sm-8 ">

            <p class="success_story">Real People <span class="stories">Real Stories</span></p>
            ...
            <p>
                <?php
                    ...
                    $stories = SuccessStoriesModel::where('status', 1)->first();
                    $storiesArray = SuccessStoriesModel::where('status', 1)->get();
                   
                   
                        $image = SuccessStoriesModel::where('status', 1)->first(); // Retrieving the image with status 1
  ...
  @if(count($storiesArray)>0)
            <p class="bold textcolor">Meet <i>{{$stories->name}}</i> </p>
            ...
            <p class="textcolor">
                ...
                <span id="dotssuccessStory"></span><span id="moresuccessStory">
                    {{ (strlen($stories->description)>500)? substr($stories->description, 501, 2500): $stories->description}}
                      </span>
            </p>
            <p onclick="myFunctionsuccessStory()" id="myBtnsuccessStory" class="know_more_color">Read more</p>
          @else
            <span class="bold textcolor">Coming Soon.......</span>
            @endif
        ...
        <div class="col-sm-4 text-center">
            ...
            @if(isset($imagePath))
            <img src="{{ $imagePath }}" alt="Image" class="photo" height="300px" width="200px;">
    ...
    <div class="row paddingleft paddingright">
        <div class="card " style="height: 15rem;">
            <div class="card-header new_background_color"
                style="font-family: Elephant; color:white; border-radius:5px;text-align:center">
                Notification
            </div>
            <div class="card-body ">
                <div class="table-responsive">
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <td><a  href="{{route('notification.getdoc',[$row->notification_id])}}" target="_blank">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-10">
                    <div class="card-header verdana  new_background_color">
                        <h4 class="verdana dihasTitle white_font_color">Frequently Asked Questions(FAQ)</h4>
                    </div>
                    <div class="card-body verdana ">
                        ...
                        <!-- Seema -->
                        <p id="myBtnfaq" style="color:blue">Know more</p>
                        <br><br>
