  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-center pt-5">
        <h1 class="display-one mt-5">New Designation Form</h1>
        ...
        <form id="add-frm" method="POST" action="" class="border p-3 mt-2">
          <div class="control-group col-6 text-left">
            ...
            <div>
              <input type="text" id="desig_name" class="form-control mb-4" name="desig_name" placeholder="Enter Designation" required>
            </div>
          </div>

          @csrf

          <div class="control-group col-6 text-left mt-2"><button class="btn btn-primary">Add New Designation</button></div>
        </form>
      </div>
    </div>
  </div>
