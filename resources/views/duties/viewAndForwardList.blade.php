...
@section('content')
    <div class="pt-3">
        ...
        <div class="d-flex justify-content-between">
            <div class="my-2">
                <button class="btn btn-sm btn-primary statusBtn" data-application_status="pending"
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        const bulkForwardUrl = "{{ route('duties.view-and-forward.bulkForward') }}";
        const ajaxDataListUrl = "{{ route('duties.view-and-forward.ajaxlist', $task->tasks_id) }}";
                    ...
                    fetch(url, {
                        ...
                        .then(data => {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Success',
                                text: 'Selected proforma(s) have been successfully forwarded'
                            }).then(() => {
