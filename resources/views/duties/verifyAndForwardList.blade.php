...
<div class="container-fluid pt-3 px-5">
    ...
    <div class="my-4">
        <button class="btn btn-sm btn-success statusBtn" data-application_status="un-verified" type="button">Un-Verified</button> |
        <button class="btn btn-sm btn-primary statusBtn" data-application_status="verified" type="button">Verified</button> |
