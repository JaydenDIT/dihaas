                                        ...
                                        <div class="row align-items-center mb-2">
                                            <div class="col-sm-8">
                                                <div class="form-check d-flex align-items-center">
                                                    <input class="form-check-input me-2  mb-1 doc-checkbox" type="checkbox"
                                                    ...
                                                    <label class="form-check-label fw-bold mb-0"
                                                        for="doc_{{ $doc->uploaded_document_id }}">
...
@push('js')
    ...
    <script>
        ...
        const confirmRedirectUrl =
            "{{ route('duties.verify.document.index', $tasks['current']['tasks_id']) }}?view=verified";
