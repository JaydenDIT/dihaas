...
<head>
    ...
    <style nonce="{{ csp_nonce() }}">
        ...
        .top-container_hidden {
            top: -150px;
            /* Hide the top container by moving it above the viewport */
        }
    </style>
</head>
...
<body>
            ...
            <div class="row">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="myHeader2">
                    ...
                    <a class="verdana_txtnone nav-link"
                        href="{{ url('ddo-assist/viewRejectedListHODAssist') }}">Reverted List</a>
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/viewFileStatus') }}">File Status</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                    ...
                                    <li class="nav-item dropdown">
                                        <!-- Add dropdown class to this list item -->
                                        <a class="verdana_txtnone nav-link dropdown" href="#"
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <!-- Add dropdown menu items here -->
                                            <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ route('screening.view') }}">Screening Committee
                                                    Report</a></li>
                                            <li><a class=" verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ route('viewSeniorityStatus') }}">Department Seniority
                                                    List</a></li>
                                            {{-- <li><a class=" verdana_txtnone dropdown-item yellow-bg"
                    ...
                    <a class="verdana_txtnone nav-link" aria-current="page"
                        href="{{ url('ddo-assist/viewTransferListByHodAssistant') }}">Transfer Applicants</a>
                                ...
                                @if (Auth::user()->role_id == 2)
                                    <li class="nav-item ">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/viewForwardEmp') }}">
                    ...
                    <a class="verdana_txtnone nav-link" href="{{ url('ddo-assist/viewRejectedListHOD') }}">
                        Reverted List
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/viewFileStatus') }}">
                                            Files Status
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/selectDeptByDPApproveDept') }}">
                                            Approved List
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/vacancystatus') }}">
                                            Vacancy Status
                                        </a>
                                    </li>
                ...
                @endif --}}
                                ...
                                @if (Auth::user()->role_id == 5)
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/selectDeptByDPAssist') }}">
                                            Forwarded Applicants
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/selectDeptByDPApprove') }}">
                                            Approved List
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/viewRevertedListDP') }}">
                                            Reverted List
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ route('screening.new') }}">Screening Committee Report</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/viewFileStatusByDPDept') }}">
                                            Files Status
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/vacancy_list_dpview') }}">
                                            Vacancy Status
                                        </a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                                    ...
                                                    Report</a></li>
                                            <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ route('viewSeniorityStatus') }}">Inter-Department
                                                    Seniority List</a></li>
                                        </ul>
                                    </li>
                                    {{-- <li class="nav-item">
                    <a class="verdana_txtnone nav-link" href="{{ url('ddo-assist/transfer_applicant_By_DPAssist') }}">
                        Transfer Applicant
                                ...
                                @if (Auth::user()->role_id == 6)
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/selectDeptByDPNodal') }}">
                                            Forwarded Applicants
                                        </a>
                                    </li>
                    ...
                    <a class="verdana_txtnone nav-link" href="{{ url('ddo-assist/selectDeptByDPApprove') }}">
                        Approved List
                                    ...
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('ddo-assist/selectDPAppointment') }}">
                                            Appointed List
                                        </a>
                                    </li>
                                ...
                                @if (Auth::user()->role_id == 8)
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('/viewEsignByDeputySecretary') }}">
                                            Pending for eSign
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                                    ...
                                                    Report</a></li>
                                            <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ route('viewSeniorityStatus') }}">Inter-Seniority List</a>
                                            </li>
                                        </ul>
                                    </li>
                                @endif
                                ...
                                @if (Auth::user()->role_id == 9)
                                    <li class="nav-item">
                                        <a class="verdana_txtnone nav-link"
                                            href="{{ url('/viewEsignByDepartmentSigningAuthority') }}">
                                            Pending for eSign
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                @if (Auth::user()->role_id == 999)
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <li class="nav-item">
                                                <a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ url('/remarksapproves') }}">
                                                    Remarks Approve
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ url('/remarksrejects') }}">
                                                    Remarks Reject
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ url('/dpauthorities') }}">
                                                    DP Signing Authority
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ url('/deptauthorities') }}">
                                                    Department Signing Authority
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ url('/successstories') }}">
                                                    Upload Success Story
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="verdana_txtnone dropdown-item yellow-bg"
                                                    href="{{ url('/uploadimages') }}">
                                                    Upload Photo
                                                </a>
                                            </li>
                                        </ul>
                            ...
                            @guest
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
                                        ...
                                        <i class="fontncolor fa-solid fa-user "></i><b
                                            class="white">{{ Auth::user()->name }}</b>
                                    </a>
                                    <ul class="dropdown-menu   dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('setting.profile') }}">
                                                <i class="font20 fa-solid fa-lock"></i><span class="color"> Change
                                                    Password</span>
                                            </a>
                                        <li>
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('logout') }}"
                                                ...
                                                <i class="font20 fa-solid fa-user"></i><span
                                                    class="color">{{ __('Logout') }}</span>
                                            </a>
                                            @csrf
    ...
    @if (request()->is('sitemap', 'dihas_overview', 'contact_us'))
        ...
        <div class="sitemap_background">
            <div class="container">
                <div class="row">
                    <div class="col-12 dihas_flex">
                        <img src="{{ asset('assets/images/kanglasha.png') }}" alt="emblem"
                            class="my-1 kanglasha_logo">
        ...
        <div class="top-container_first ps">
            ...
            <div style="background-color:#0f523e;">
                <div class="container d-flex justify-content-end  py-2">
                    ...
                    <a href="/" style="text-decoration:none;  font-size:13px;" class="text-white">Back to
                        home</a>
                </div>
            </div>
            ...
            <div class="row" style="height: 50px; background-color: #383838;">
                <div class="col-sm-12 d-flex justify-content-center" style="display: flex; margin-top: 10px;">
                    ...
                    <p style="margin-right: 20px;  background-color: #383838;" class=" text-white"
                        id="resetFontSizeBtn">A
                    </p>
                    <p style="margin-right: 20px;  background-color: #383838;" class=" text-white"
                        id="increaseFontSizeBtn">
                        +A</p>
                    <p
                        style=" margin-top: 4px; margin-right: 10px;border-left: 2px solid grey; height: 15px; background-color: #383838;">
                    </p>
    ...
    @if (Auth::user() == null &&
            request()->url() != url('citizen/register') &&
            !request()->is('sitemap') &&
            !request()->is('dihas_overview') &&
            ...
            <div class="row" style="height: 50px; background-color: #383838;">
                <div class="col-sm-12 d-flex justify-content-center" style="display: flex; margin-top: 10px;">
                    ...
                    <p style="margin-right: 20px;  background-color: #383838;"class=" text-white "
                        id="decreaseFontSizeBtn">-A</p>
                    <p style="margin-right: 20px;  background-color: #383838;" class=" text-white"
                        id="resetFontSizeBtn">A</p>
                    <p style="margin-right: 20px;  background-color: #383838;" class=" text-white"
                        id="increaseFontSizeBtn">+A</p>
                    <p
                        style=" margin-top: 4px; margin-right: 10px;border-left: 2px solid grey; height: 15px; background-color: #383838;">
                    </p>
                ...
                <div class="row">
                    <div class="col-12 dihas_flex">
                        ...
                        <div class="nav-item dropdown manual_design">
                            <!-- Add dropdown class to this list item -->
                            <a class="verdana_txtnone nav-link dropdown" href="#" id="navbarDropdown"
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <!-- Add dropdown menu items here -->
                                <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                        href="{{ asset('assets/files/citizen.pdf') }}" target="blank">Citizen
                                        User</a></li>
                                <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                        href="{{ asset('assets/files/department.pdf') }}" target="blank">Department
                                        User</a></li>
                                <li><a class="verdana_txtnone dropdown-item yellow-bg"
                                        href="{{ asset('assets/files/superadmin.pdf') }}" target="blank">Superadmin
                                        User</a></li>
                            </ul>
                        </div>
                        <a href="/contact_us" class="dihas_contact_us text_contact_us">
