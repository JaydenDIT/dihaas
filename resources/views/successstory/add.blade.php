    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center pt-5">
                <h1 class="display-one mt-5">New Success Story Form</h1>
                ...
                <form id="add-frm" method="POST" action="" class="border p-3 mt-2" enctype="multipart/form-data">
                    ...
                    <div class="control-group col-6 text-left">
                        ...
                        <div>
                            <input type="text" id="description" class="form-control mb-4" name="description"
                                placeholder="Enter  Success Story" required>
                        </div>
                    </div>
                    ...
                    <div class="control-group col-6 text-left mt-2"><button class="btn btn-primary">Add New Success
                            Story</button></div>
                </form>
            </div>
        </div>
