        ...
        <div class="row mb-3 justify-content-center row_width" style="gap:7%">
            ...
            <div class="card card_width">
                <div class="card-body">
                    ...
                    <h6 class="card-text verdana change_font">Required documents as per the scheme will be uploaded
                        here....</h6>
                    ...
                    @if ($images->count() > 0)
                        <div class="flex">
                            @foreach ($images->take(3) as $image)
                                <a href="{{ route('image.show', ['filename' => $image->image]) }}"> <img
                                        class="d-block p-2"
                                        src="{{ route('image.show', ['filename' => $image->image]) }}" alt="Your Image"
                                        height="100px" width="200px;" data-bs-toggle="modal"
                                    ...
                                    @foreach ($notifications as $row)
                                        <tr>
                                            <td><a class="change_font"
                                                    href="{{ route('notification.getdoc', [$row->notification_id]) }}"
                                                    target="_blank">
