        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-7">
                    ...
                    @endif
                    <div class="card">
                        <h5 class="text-center my-3" style="color:crimson">Information: Install Sandes App from Google
                            Playstore to receive OTP and Message from the Portal</h5>
                        <div class="card-header" align="center"
                            style="font-family: Elephant;font-size: 20px;font-weight:bold;line-height:66px;color:mediumblue">
                            {{ __('Superadmin  Login') }}
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="#" name="login-form" id="login-form">
                                ...
                                <div class="mb-3 row">
                                    <label for="password"
                                        class="col-md-4 col-form-label text-md-end text-start">{{ __('Password') }}</label>
                            ...
                            <div class="row mb-1 login-div" style="display: none;">
                                <div class="col-md-6 offset-4" style="display: flex; align-items: center;">
                                    ...
                                    <button class="link" type="button" id="resendBtn"
                                        style="border-radius: 50px; color:blue; margin: 0 0 0 10px;  background-color: white; border-color: rgba(0, 0, 255, 0);"
                                        disabled>
                                        Resend OTP
                                    </button>
                                </div>
                                ...
                                <div class="row mb-3 justify-content-center">
                                    <button type="button" class="btn btn-primary" disabled id="loginBtn"
                                        style="width:80px;">
                                        Login
                                    </button>
