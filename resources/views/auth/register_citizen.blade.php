                        ...
                        <div class="vstack gap-2 card bg-light border-dark my-3 py-2">
                            <div class="container">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="current_pin" id="current_pin" class="form-control mb-2"
                                ...
                                <div>
                                    ...
                                    <select name="current_state_id" id="current_state_id"
                                        data-change="current_district_id" class="form-select funSelectChange" required>
                            ...
                            <div class="container">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="permanent_pin" id="permanent_pin"
                                        class="form-control mb-2" min-length="6" max-length="6" required>
                                    <div class="invalid-feedback" role="alert">
                                        Please enter Pin Code.
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="permanent_state_id" id="permanent_state_id"
                                        data-change="permanent_district_id" class="form-select funSelectChange" required>
                                        <option value="" disabled selected>Choose State....</option>
                                        @foreach ($states as $row)
                                            <option value="{{ $row->id }}">{{ $row->name }}</option>
                                        @endforeach
