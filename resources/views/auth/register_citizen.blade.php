        ...
        <div class="card-body">
            <form method="POST" name="new_user_form" id="new_user_form" class="row g-3 needs-validation" novalidate
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="mobile" id="mobile" placeholder="{{ __('Mobile') }}" maxlength="10"
                ...
                <div class="col-md-6">
                    <label for="relative_name" class="form-label register-rsp"><b>Father's/Mother's/Spouse's
                            Name</b></label>
                ...
                <div class="col-md-6">
                    <label for="relationship_id" class="form-label register-rsp"><b>Relationship with the
                            Applicant</b></label>
                    ...
                    <div class="vstack gap-2 card bg-light border-dark my-3 py-2">
                        <div class="container">
                            ...
                            <div>
                                ...
                                <select name="current_state_id" id="current_state_id"
                                    data-change-id="current_district_id" class="form-select state_options" required>
                            ...
                            <div>
                                ...
                                <input type="text" name="current_pin" id="current_pin" class="form-control mb-2 is_number"
                ...
                <div class="col-md-6">
                    <div class="hstack">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="same_as_current" name="same_as_current">
                            <label class="form-check-label cursor-pointer" for="same_as_current">
                        ...
                        <div class="container">
                            <div>
                                ...
                                <input type="text" name="permanent_address1" id="permanent_address1"
                                    class="form-control mb-2 permanent_input permanent_required" required>
                                <!--permanent_address2-->
                                <input type="text" name="permanent_address2" id="permanent_address2"
                                    class="form-control mb-2 permanent_input">
                                <!--permanent_address3-->
                            ...
                            <div>
                                ...
                                <select name="permanent_state_id" id="permanent_state_id"
                                    data-change-id="permanent_district_id"
                                    class="form-select state_options permanent_input permanent_required" required>
                                    <option value="" disabled selected>Choose State....</option>
                                    @foreach ($states as $row)
                                    <option value="{{ $row->id }}">{{ $row->name }}</option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                <select name="permanent_district_id" id="permanent_district_id"
                                    class="form-select permanent_input permanent_required"
                                    required>
                                    <option value="" disabled selected>Choose District....</option>
                                </select>
                                <div class="invalid-feedback" role="alert">
                            ...
                            <div>
                                ...
                                <input type="text" name="permanent_pin" id="permanent_pin"
                                    class="form-control mb-2 is_number permanent_input permanent_required" maxlength="6" minlength="6" required>
                                <div class="invalid-feedback" role="alert">
                                    Please enter Pin Code.
                                </div>
                            </div>
                ...
                <div class="col-12">
                    <button type="button" class="btn btn-primary" id="registerSave">Register</button>
                </div>
            </form>
        </div>
        <!--End of card body-->
            ...
            <form class="needs-validation" name="otp-form" id="otp-form" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            <input type="number" maxlength="10" class="" name="mobile_otp" class=""
                                id="mobile_otp">
                        </div>
                    </div>
...
<script nonce="{{ csp_nonce() }}">
    ...
    const register_url = "{{ route('citizen.preRegistration') }}";
    const otpsubmit_url = "{{ route('citizen.saveRegistration') }}";

    const login_url = "{{ route('welcome') }}";

    const resendSMSOTP = "{{ route('citizen.smsRegistrationOTP') }}";
    const resendEmailOTP = "{{ route('citizen.emailRegistrationOTP') }}";
</script>
