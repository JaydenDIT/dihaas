...
<div class="container">
	<div class="row">
		<div class="col-12 text-center pt-5">
			<h1 class="display-one mt-5">New Vacancy Percentage Form</h1>
			...
			<form id="add-frm" method="POST" action="" class="border p-3 mt-2">
				<div class="control-group col-6 text-left">
					<label for="vpercentage">Vacancy Percentage</label>
					<div>
						<input type="text" id="vpercentage" class="form-control mb-4" name="vpercentage"
							placeholder="Enter Vacancy Percentage" required autocomplete="off">
					</div>
				</div>
				<div class="control-group col-6 text-left">
					...
					<div>
						<input type="date" id="year" class="form-control mb-4" name="year"
							placeholder="Select" required autocomplete="off">
					</div>
				</div>
				
				@csrf

				<div class="control-group col-6 text-left mt-2"><button class="btn btn-primary">Add Only One New Vacancy Percentage</button></div>
			</form>
		</div>
	</div>
</div>
