...
<div class="container">
	<div class="row">
		<div class="col-12 text-center pt-5">
			<h1 class="display-one mt-5">New Department Form</h1>
			...
			<form id="add-frm" method="POST" action="" class="border p-3 mt-2">
				...
				<div class="control-group col-6 text-left mt-2"><button class="btn btn-primary">Add New Department</button></div>
			</form>
		</div>
	</div>
</div>
