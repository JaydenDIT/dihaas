                ...
                <div class="container">
                    ...
                    @if (session('status'))
                        ...
                        <div id="form_body" class="displayshow">
                            <!-- ROW-1 -->
                            <form method="POST" action="{{ route('save-family-applicant-update') }}" class="">
                                @csrf
                                    ...
                                    <tr>
                                        ...
                                        @if($data->relation == null || $data->relation == '')
                                            ...
                                            <select class="form-select bordercolor" aria-label="Default select example" name="old_data[{{$loop->index}}][relation]">
                                                ...
                                                <option value="5" {{$data->relation =='5' ? 'selected' : '' }}>Transgender</option>
                                            </select>
                                            @else
                                        ...
                                        <td>
                                            @if($status == 1)
                                            <a class="btn" href="{{ route('delete-family-applicant-update', Crypt::encryptString($data->id))}}">
                                ...
                                <div class="col-sm-12">
                                <a href="{{ route( URL::previous()) }}" class="btn btn-success btn-sm">Back</a>&nbsp;&nbsp;&nbsp;
                                      ...
                                      &nbsp;&nbsp;&nbsp;<a href="{{ route('create-applicant-self-update') }}" id="close" class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button" aria-disabled="true">
                                      Next
                                      </a> 
