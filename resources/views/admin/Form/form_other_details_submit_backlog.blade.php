                       ...
                       <a href="{{ route('downloadDetails') }}" target="_blank" class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button" aria-disabled="true">
                        ...
                        <div class="row">
                            ...
                            <a href="{{ URL::previous() }}" class="btn btn-success btn-sm">Back</a>&nbsp;&nbsp;&nbsp;
                                <a href="{{ route('submit-forms-backlog') }}" id="submit_form1" class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button" aria-disabled="true">
                                            Submit
                                        </a>
...
<script nonce="{{ csp_nonce() }}">
    document.addEventListener("DOMContentLoaded", function() {
        var discardLink = document.getElementById("submit_form1");
