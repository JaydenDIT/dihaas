                ...
                <div class="container">
                    ...
                    @if (session('status'))
                        ...
                        <div id="form_body" class="displayshow">
                            <!-- ROW-1 -->
                            {{-- <form method="POST" action="{{ url('ddo-assist/save-family-details') }}" class=""> --}}
                                ...
                                <table class="table" id="multiForm">
                                    ...
                                    <tr>
                                        <td>
                                            <input readonly type="text" name="new_data[0][name]" class="form-control" value="" />
                                        </td>
                                        <td>
                                            <input readonly type="date" name="new_data[0][dob]" class="form-control" value="" />

                                        </td>
                                        <td>
                                            <!-- <input type="text" name="gender[0][gender]" class="form-control" /> -->
                                            <select disabled class="form-select" aria-label="Default select example" name="new_data[0][gender]">
                                        ...
                                        <td>
                                            <input readonly type="text" name="new_data[0][relation]" class="form-control" value="" />
                                        </td>
                                        <!-- <td>
                                        ...
                                        <td>
                                            @if($status != 1)
                                            <input readonly type="button" name="add" value="Add" id="addRemoveIp" class="btn btn-outline-success">
                                            @endif
                                        </td>
                                    </tr>
                                    @else
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @if($data->name == null)
                                            <input readonly type="text" name="old_data[{{$loop->index}}][name]" class="form-control bordercolor" value="{{$data->name}}" />
                                            @else
                                            <input readonly type="text" name="old_data[{{$loop->index}}][name]" class="form-control" value="{{$data->name}}" />
                                            @endif

                                        </td>
                                        <td>
                                            @if($data->dob == null)
                                            <input readonly type="date" name="old_data[{{$loop->index}}][dob]" class="form-control bordercolor" value="{{$data->dob}}" />
                                            @else
                                            <input readonly type="date" name="old_data[{{$loop->index}}][dob]" class="form-control" value="{{$data->dob}}" />
                                            @endif
                                        </td>
                                        <td>
                                            <!-- <input type="text" name="gender[0][gender]" class="form-control" /> -->
                                            @if($data->gender == null || $data->gender == '')
                                            <select disabled class="form-select bordercolor" aria-label="Default select example" name="old_data[{{$loop->index}}][gender]">
                                            ...
                                            @else
                                            <select disabled class="form-select" aria-label="Default select example" name="old_data[{{$loop->index}}][gender]">
                                                <option Value="" {{$data->gender =='' ? 'selected' : '' }}>Select </option>
                                                <option value="M" {{$data->gender =='M' ? 'selected' : '' }}>Male</option>
                                                <option value="F" {{$data->gender =='F' ? 'selected' : '' }}>Female</option>
                                                <!-- <option value="T" {{$data->gender =='T' ? 'selected' : '' }}>Transgender</option> -->
                                        ...
                                        @if($data->relation == null || $data->relation == '')
                                            ...
                                            <select disabled class="form-select bordercolor" aria-label="Default select example" name="old_data[{{$loop->index}}][relation]">
                                            ...
                                            <select disabled class="form-select" aria-label="Default select example" name="old_data[{{$loop->index}}][relation]">
                                            <option Value="" {{$data->relation =='' ? 'selected' : '' }}>Select </option>
                                                <option value="1" {{$data->relation =='1' ? 'selected' : '' }}>Wife</option>
                                                <option value="2" {{$data->relation =='2' ? 'selected' : '' }}>Husband</option>
                                                <option value="3" {{$data->relation =='3' ? 'selected' : '' }}>Son</option>
                                        ...
                                        <td>
                                            @if($status != 1)
                                            <a class="btn" href="{{ route('delete-family-member', Crypt::encryptString($data->id))}}">
                                ...
                                <div class="col-sm-12 textright">
                                    <div class="col-sm-12">
                                        @if($status == 1)
                                        <a href="{{ route('uploaded-applicant-files') }}" class="btn btn-success btn-sm" tabindex="-1" role="button" aria-disabled="true">Next</a>
                                        @else
                                        <button type="submit" class="btn btn-success btn-sm" id="save_family_btn_fresh" >Save</button>
