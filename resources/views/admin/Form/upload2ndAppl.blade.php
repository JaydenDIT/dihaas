...
<span class="font_color">Last date of submission.....</span>
<br>
                    </div>
                    <hr>
                        <div class="row">
                    ...
                    <div class="container">
                        <form name="uploadform" action="{{route('upload-applicant-files2ndAppl')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                                ...
                                <div class="alert alert-danger">
                                 ...
                                 @endif 
                                <div id="form_header" class="textalign_fontsize"><b>Upload Documents for 2nd Applicant</b>
                            </div>
