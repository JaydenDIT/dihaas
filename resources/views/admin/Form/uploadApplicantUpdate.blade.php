        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 margintop">
                ...
                <div class="card displayshow" id="emolument_section">
                    ...
                    <div class="container">
                        <form name="uploadform" action="{{route('upload-applicant-self-update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="position-relative">
                                <div class="label position-absolute top-50 start-50 translate-middle">
                                    ...
                                    <a href="{{ route('view-family-details-dihas') }}" class="btn btn-success btn-sm">Back</a>
                                    &nbsp;&nbsp;&nbsp;
                                    <button type="button" class="btn btn-success" id="submitButton">Submit</button>
                                    &nbsp;&nbsp;&nbsp;
                                    <a href="{{ route('other_form_details_dihas') }}" id="close" class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button" aria-disabled="true">
                                          Next
                                    </a>
    ...
    {{-- </div>
                    <script nonce="{{ csp_nonce() }}">
                        onSubmitHandler = () =>{
                          ...
                          document.uploadform.action = "upload-applicant-files-draft";
                          document.uploadform.submit();
                      }
                      onUpload = () =>{
                         document.uploadform.action = "upload-applicant-files";
                         document.uploadform.submit();
                      }

                      onDelete = (id) =>{
                          document.uploadform.deleteId.value = id;
                         document.uploadform.action = "upload-applicant-files-fdelete";
                         document.uploadform.submit();
