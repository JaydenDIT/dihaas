                        ...
                        <div id="form_body" class="displayshow">
                            ...
                            <form id= "form_family_details" method="" action="" class="">
                                ...
                                <div class="col-sm-12 textright">
                                    <div class="col-sm-12">
                                    <!-- view-family-details-dihas -->
                                      
                                        <a href="{{ route(URL::previous()) }}" class="btn btn-success btn-sm">Back</a>&nbsp;&nbsp;&nbsp;

                                        <button type="submit" class="btn btn-success btn-sm" id="save_family_btn_backlog">Save As Draft</button>
                                        &nbsp;&nbsp;&nbsp;<a href="{{ route('create-backlog-files') }}" id="close" class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button" aria-disabled="true" >
                                      Next
                                      </a> 
