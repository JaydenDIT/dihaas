                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-12 textleft">
                                <b>EIN: {{$empDetails->ein }} &nbsp; Deceased Name :
                                    {{ $empDetails->deceased_emp_name }} &nbsp; D.O.E:
                                    {{date('Y-m-d', strtotime($empDetails->deceased_doe))}} &nbsp;&nbsp;&nbsp; Applicant
                                    Name : {{ $empDetails->applicant_name }}</b>
                    ...
                    <div class="container">
                        <form class="upload-form">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <div id="form_header" class="textalign_fontsize"><b>Upload Documents</b>
                                </div>
                                <h6 class="color_fontweight"> NOTE : Documents marked with asterisk (*) are mandatory
                                </h6>
                                <br>
                                @foreach($reqDocs as $docs)
                                <input type="hidden" name="row[{{$loop->index}}][doc_id]" value="{{$docs['doc_id']}}">

                                <input type="hidden" name="row[{{$loop->index}}][doc_name]"
                                    value="{{$docs['doc_name']}}">
                                <input type="hidden" name="row[{{$loop->index}}][is_mandatory]"
                                    value="{{$docs['is_mandatory']}}">
                                ...
                                <div class="table-responsive">
                                    <div class="row p-2">
                                        ...
                                        <div class="col-3">
                                            <input class="form-control" type="file" id="{{$docs['doc_id']}}"
                                                name="row[{{$loop->index}}][file]"
                                ...
                                <div class="position-relative">
                                    <div class="label position-absolute top-50 start-50 translate-middle">
                                        ...
                                        &nbsp;&nbsp;&nbsp;<a href="{{ route('other_form_details_dihas') }}" id="close"
