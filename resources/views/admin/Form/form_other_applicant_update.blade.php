                ...
                <div class="container">
                    ...
                    <div class="card-body">
                       ...
                       <a href="{{ route('downloadDetails') }}" target="_blank" class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button" aria-disabled="true">
                        ...
                        <div class="row">
                        <div class="col-sm-12 textcenter">
                            <a href="{{ route('create-applicant-self-update') }}" class="btn btn-success btn-sm">Back</a>&nbsp;&nbsp;&nbsp;
                                <a href="{{ route('submit-applicant-update') }}" id="submit_applicant_update" class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button" aria-disabled="true">
                                            Submit
                                        </a>
...
<script nonce="{{ csp_nonce() }}">
    document.addEventListener("DOMContentLoaded", function() {
        var discardLink = document.getElementById("submit_applicant_update");
