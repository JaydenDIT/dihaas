...
<body onload="firstfocus();">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 margintop">
                ...
                <div class="card displayshow" id="desc_role_section">
                    ...
                    <div class="container">
                        <div class="card-body">
                            <div id="ein-validation-message" class="error">{{($notfound != null)?$notfound:''}}</div>
            ...
            @endif
                            ...
                            <div id="form_body" class="displayshow">
                                <form name="descriptiveRoleForm" id="descriptiveRoleForm" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="date"
                                                ...
                                                pattern="\d{4}-\d{2}-\d{2}" onblur="validateAge();" placeholder=""
                                                id="applicant_dob" name="applicant_dob"
                                                value="{{ old('applicant_dob') }}" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2 textleft">
                                            ...
                                            <label for="post_applied"><b>Post Preference</b></label>
                                    ...
                                    <div class="row textright">
                                        <div class="col-sm-12">
                                            ...
                                            <button type="submit" class="btn btn-success btn-sm"
                                                id="desc_role_next_btn">Save As Draft</button>
                                            &nbsp;&nbsp;&nbsp;<a href="{{ route('enter-family-details-backlog') }}"
                                                id="close" class="btn btn-success btn-sm marginbottom" tabindex="-1"
    ...
    <script type="text/javascript" src="{{ asset('assets/js/auth/proformabacklogsave.js') }}"></script>
