...
<div class=" container content-section ">
            ...
            <div class="form-container">
                <div class="container">
                    ...
                    <div class="row background">
                        ...
                        <div class="col displayflex">
                            <div>
                                <input type="radio" name="login" id="register-btn" checked>
                            </div>
                            <div>
                ...
                <form id="login-form" class="new_background_color1 displaynone">
                    <div class="card-body">
    ...
    <div class="row mb-3 justify-content-center row_width" style="gap:8%">
        ...
        <div class="card card_width">
            <div class="card-body">
                ...
                <h6 class="card-text verdana change_font">Applicant details information, address, post apply will be
                    entered....
                </h6>
        ...
        <div class="card card_width">
            <div class="card-body">
                ...
                <h6 class="card-text verdana change_font">All family members details excluding applicant will be
                    entered....</h6>
            </div>
        </div>
        <div class="card card_width">
            <div class="card-body">
                ...
                <h6 class="card-text verdana change_font">Required documents as per the scheme will be uploaded here....
                </h6>
        ...
        <div class=" new_background_color mb-3" style="border-radius:20px;">
            <div class="row g-0">
                ...
                <div class="col-sm-4 text-center">
                    ...
                    @if($image)
                    <img src="{{ route('image.show', ['filename' => $image->image]) }}" alt="Your Image" class="photo"
    ...
    <div class="row  row_width">
        <div class="card " style="height: 15rem;">
            <div class="card-header new_background_color "
                ...
                <h4 class="dihasTitle">Notification</h4>
            </div>
            <div class="card-body ">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-10">
                    <div class="card-header verdana  new_background_color">
                        <h4 class="verdana dihasTitle white_font_color apply_font_size_faq ">Frequently Asked
                            Questions(FAQ)</h4>
                    </div>
    ...
    <div class="row mb-3 justify-content-center " style="gap:0.1%">
        ...
        <div class="icon_width">
            <a href="https://treasurymanipur.nic.in/" target="blank">
                <img src="{{asset('assets/images/treasury.png')}}" alt="emblem" height="90" width="200"
                    style="padding-top:10px;">
            </a>
        </div>
        <div class=" icon_width">
        ...
        <div class=" icon_width">
            <a href="https://egrasmanipur.nic.in/" target="blank">
                <img src="{{asset('assets/images/egras.jpg')}}" alt="emblem" height="100" width="200">
            </a>
