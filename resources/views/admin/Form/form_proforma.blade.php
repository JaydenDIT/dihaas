    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 text-center mt-4">
                ...
                <p class="colourred" id="sixMonthsLater"></p>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="col-md-12 margintop">
                ...
                <div class="card displayshow" id="desc_role_section">
                    ...
                    <div class="container">
                        <div class="card-body">
                            <div id="ein-validation-message"></div>
                            @if (session('status'))
            ...
            @endif
                            ...
                            <div id="form_body" class="displayshow">
                                ...
                                <form name="descriptiveRoleForm" autocomplete="off" id="descriptiveRoleForm" action=""
                                    ...
                                    <div id="form_header" class="textcenter_fontsize">
                                        <b>Proforma Data Entry {{$notfound}} </b>
                                    </div><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-sm-3">
                                            <input type="text" class="form-control @error('ein') is-invalid @enderror"
                                                onblur="fieldValidate('ein');" name="ein" id="ein"
                                                value="{{ (count($data)>0)?$data['emp_state_ein']:'' }}" placeholder=""
                                                required>
                                            @error('einError')
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control"
                                                onblur="fieldValidate('deceased_emp_name')" name="deceased_emp_name"
                                                id="deceased_emp_name"
                                                value="{{ (count($data)>0)?$data['emp_title'].' '.$data['emp_lname']:'' }}"
                                                readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text"
                                                ...
                                                value="{{ (count($data)>0)?$data['field_dept_desc']:'' }}"
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text"
                                                ...
                                                value="{{ (count($data)>0)?$data['adm_dept_desc']:'' }}" placeholder=""
                                                readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="date"
                                                class="form-control  @error('deceased_doa') is-invalid @enderror"
                                                name="deceased_doa" id="deceased_doa"
                                                value="{{ (count($data)>0)? $data['emp_entry_dt']:'' }}" placeholder=""
                                                readonly>
                                            @error('d_doa')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text"
                                                class="form-control  @error('desig_name') is-invalid @enderror"
                                                name="desig_name" id="desig_name"
                                                value="{{ (count($data)>0)?$data['emp_desig']:'' }}" placeholder=""
                                                readonly>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="date"
                                                class="form-control  @error('deceased_dob') is-invalid @enderror"
                                                placeholder="" id="deceased_dob" name="deceased_dob"
                                                value="{{ (count($data)>0)?$data['emp_birth_dt']:'' }}" readonly>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text"
                                                ...
                                                name="grade_name" id="grade_name"
                                                value="{{ (count($data)>0)?$data['emp_group']:'' }}" placeholder=""
                                                readonly>
                                            @error('grade_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-sm-3 ">
                                            ...
                                            <div class="displayflex">
                                                <div class="marginright">
                                                    <label class="radio-inlin" for="yes"><b>
                                                            <input type="radio"
                                                                class="  @error('expire_on_duty') is-invalid @enderror"
                                                                id="Yes" name="expire_on_duty" value="yes"
                                                                {{ old('Yes') == 'yes' ? 'checked' : '' }}>Yes</b></label><br>
                                                </div>
                                                <div>
                                                    <label class="radio-inline marginL" for="no"><b>
                                                            <input type="radio"
                                                                class=" @error('expire_on_duty') is-invalid @enderror"
                                                                id="No" name="expire_on_duty" value="no"
                                                                {{ old('No') == 'no' ? 'checked' : '' }}
                                                                checked>No</b></label><br>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            is-invalid @enderror" pattern="\d{4}-\d{2}-\d{2}" placeholder=""
                                                id="deceased_doe" name="deceased_doe" value="{{ old('deceased_doe') }}"
                                                required>

                                            <p class="colourred" id="deceased_doeError"></p>
                                            @if($getUser->role_id == 77)
                                            <div id="dateValidationError" class="colourred"></div>
                                            @endif
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text"
                                                ...
                                                value="{{ old('deceased_causeofdeath') }}" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ $formattedDate }}"
                                                id="appl_date" name="appl_date" readonly>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="date"
                                                ...
                                                name="appl_date" value="{{ old('appl_date') }}" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="date"
                                                ...
                                                pattern="\d{4}-\d{2}-\d{2}" placeholder="" id="applicant_dob"
                                                name="applicant_dob" value="{{ old('applicant_dob') }}" required>
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select  @error('relationship') is-invalid @enderror"
                                                aria-label="Default select example" id="relationship"
                                                name="relationship">
                                                <option value="" selected disabled>Select</option>
                                                @foreach($Relationship as $option)
                                                <option value="{{$option['id']}}"
                                                    {{$option['id'] == $option['relationship'] ? 'selected' : ''}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input autocomplete="off" type="text"
                                                class="form-control  @error('applicant_mobile') is-invalid @enderror"
                                                placeholder="" id="applicant_mobile" name="applicant_mobile"
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select" @error('applicant_edu_id') is-invalid @enderror"
                                                ...
                                                <option value="{{$option['id']}}"
                                                    {{$option['id'] == old($option['edu_name']) ? 'selected' : ''}}
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="displayflex">
                                                <div class="marginright">
                                                    <label class="radio-inline" for="yes"><b>
                                                            <input type="radio"
                                                                class="  @error('physically_handicapped') is-invalid @enderror"
                                                                id="Yes" name="physically_handicapped" value="yes"
                                                                {{ old('Yes') == 'yes' ? 'checked' : '' }}>Yes</b></label><br>
                                                </div>
                                                <div>
                                                    <label class="radio-inline marginL" for="no"><b>
                                                            <input type="radio"
                                                                class=" @error('physically_handicapped') is-invalid @enderror"
                                                                id="No" name="physically_handicapped" value="no"
                                                                {{ old('No') == 'no' ? 'checked' : '' }}
                                                                checked>No</b></label><br>
                                                </div>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="email"
                                                class="@error('applicant_email_id') is-invalid @enderror form-control"
                                                placeholder="" id="applicant_email_id" name="applicant_email_id"
                                                value="{{ old('applicant_email_id') }}" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 ">
                                            ...
                                            <select class="form-select  @error('caste_id') is-invalid @enderror"
                                                aria-label="Default select example" id="caste_id" name="caste_id">
                                                <option value="" selected disabled>Select</option>
                                                @foreach($Caste as $option)
                                                <option value="{{$option['caste_id']}}"
                                                    {{$option['caste_id'] == $option['caste_name'] ? 'selected' : ''}}
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select  @error('sex') is-invalid @enderror"
                                                aria-label="Default select example" id="sex" name="sex">
                                                <option value="" selected disabled>Select</option>
                                                @foreach($Gender as $option)
                                                <option value="{{$option['id']}}"
                                                    {{$option['id'] == $option['sex'] ? 'selected' : ''}} required>
                                                    {{$option['sex']}}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <textarea
                                                class="form-control texttransform @error('emp_addr_lcality') is-invalid @enderror"
                                                id="emp_addr_lcality" rows="2" placeholder="" name="emp_addr_lcality"
                                                value="{{ old('emp_addr_lcality') }}"></textarea>
                                        ...
                                        <div class="col-sm-3">
                                            <textarea
                                                class="form-control  texttransform @error('emp_addr_lcality_ret') is-invalid @enderror"
                                                id="emp_addr_lcality_ret" rows="2" placeholder="Present Address"
                                                name="emp_addr_lcality_ret"
                                                value="{{ old('emp_addr_lcality_ret') }}"></textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select funSelectChange"
                                                aria-label="Default select example" id="emp_addr_district"
                                                name="emp_addr_district" data-change="emp_addr_subdiv">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select funSelectChange"
                                                aria-label="Default select example" id="emp_addr_district_ret"
                                                name="emp_addr_district_ret" data-change="emp_addr_subdiv_ret">
                                                <option value="" disabled selected>Choose District....</option>
                                            </select>
                                            <div class="invalid-feedback" role="alert">
                                                Please Select District.
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select" aria-label="Default select example"
                                                id="emp_addr_subdiv" name="emp_addr_subdiv">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-select" aria-label="Default select example"
                                                id="emp_addr_subdiv_ret" name="emp_addr_subdiv_ret">
                                                <option value="" disabled selected>Choose Sub-Division....</option>
                                            </select>
                                            <div class="invalid-feedback" role="alert">
                                                Please Select Sub-Division.
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" placeholder="Pincode."
                                                class="form-control @error('emp_pincode') is-invalid @enderror"
                                                id="emp_pincode" name="emp_pincode" value="{{ old('emp_pincode') }}"
                                                maxlength="6">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" placeholder="Pincode."
                                                class="form-control @error('emp_pincode_ret') is-invalid @enderror"
                                                id="emp_pincode_ret" name="emp_pincode_ret"
                                                value="{{ old('emp_pincode_ret') }}" maxlength="6">
                                    ...
                                    <div class="row textright">
                                        <div class="col-sm-12">
                                            ...
                                            <button type="submit" class="btn btn-success btn-sm"
                                                id="desc_role_next_btn">Save As
                                                Draft</button>
                                            &nbsp;&nbsp;&nbsp;<a href="{{ route('enter-family-details') }}" id="close"
                                                class="btn btn-success btn-sm marginbottom" tabindex="-1" role="button"
                                                aria-disabled="true">
                                                Next
                                            </a>
...
<script>
    ...
    <!-- below is for citizen -->
    <script>
    $('#deceased_doe').on('blur', function() {
        calculateSixMonthsLater();

        var selectedDate = new Date($(this).val());
        var sixMonthsEarlier = new Date('{{ now()->subMonths(6)->format("Y-m-d") }}');

        var dateValidationError = document.getElementById('dateValidationError');

        if (selectedDate < sixMonthsEarlier) {

            dateValidationError.textContent =
                'The date must be within the last 6 months from the application date.';
    ...
    function calculateSixMonthsLater() {

        var inputDate = document.getElementById('deceased_doe').value;


        var inputDateObj = new Date(inputDate);


        var sixMonthsLater = new Date(inputDateObj);
        sixMonthsLater.setMonth(sixMonthsLater.getMonth() + 6);


        var day = sixMonthsLater.getDate();
        var month = sixMonthsLater.getMonth() + 1;
        var year = sixMonthsLater.getFullYear().toString();

        //     If day is less than 10, then use the string '0' + day.
        // Otherwise, use the value of day as it is.
        day = day < 10 ? '0' + day : day;
        month = month < 10 ? '0' + month : month;

        // Combine the formatted components
        var formattedSixMonthsLater = day + '-' + month + '-' + year;


        // Display the result
        document.getElementById('sixMonthsLater').innerText = 'Last Date of Submission: ' + formattedSixMonthsLater;
    }
    </script>
    ...
    <script type="text/javascript" src="{{ asset('assets/js/auth/proformasave.js') }}"></script>
