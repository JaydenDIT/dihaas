            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6">
                        <form class="form-inline" id="ddoAststartEmpSearchBox" method="POST" action="{{ url('ddo-assist/viewRevertedListADAssistSearch') }}" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="card-body">
                    ...
                    @else
                    <a href="{{ route('viewRevertedListADAssist.downloadPDFRejectADAssist') }}" class="btn btn-success" target=”_blank”>Download Pdf</a>
                    @endif
                        ...
                        <tbody>
                            ...
                            <div class="modal fade" id="remarkModal" tabindex="-1" aria-labelledby="remarkModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form name="revertForm" action="{{ route('revertDetailsFromADAsistant1', Crypt::encryptString($data->ein)) }}" method="Post">
                                        @csrf
                                        <!-- @method('GET') -->
