        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                        <h3>{{ __('Reverted Applicantions') }}</h3>
                        </div>
                        <div class="col-6">
                        <form class="form-inline" id="ddoAststartEmpSearchBox" method="POST" action="{{ url('ddo-assist/viewRejectedListHODAssistSearch') }}" enctype="multipart/form-data" class="was-validated">
                                <div class="row textright" >
                                    ...
                                    <div class="col-2 margin_textleft" >
                ...
                <div class="card-body">
                    ...
                    @else
                    <a href="{{ route('viewRejectedListHODAssist.downloadPDFReject') }}" target="_blank" class="textdecoration">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @if(empty($empListArray))
                            <tr>
                                <td colspan="13" class="textcenter">
                                    <b>No Data Found!</b>
                                </td>
                            </tr>
                            @else
                            ...
                            <div class="modal fade" id="remarkModal" tabindex="-1" aria-labelledby="remarkModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form name="revertForm" action="{{ route('revertPersonalDetailsFrom1', Crypt::encryptString($data->ein)) }}" method="Post">
                                        @csrf
                                        <!-- @method('GET') -->
   ...
   document.addEventListener("DOMContentLoaded", function() {
       ...
       // var printButton2 = document.getElementById("myButton2");
        ...
        if (content.length === 0 || empListArrayEmpty) {
           ...
           // printButton.checkVisibility=false;
    ...
    function printList() {
        ...
        submittedApplicantRows.forEach(function(row) {
            ...
            var data12 = row.querySelector("td:nth-child(12)").innerText;
        ...
        printWindow.document.write("<p>List of Rejected applicants</p>");
        ...
        printWindow.document.write('<style>@media print {table {border-collapse: collapse;} td, th {border: 1px solid black; padding: 5px;}}</style>');
        printWindow.document.write("<thead><tr><th>Serial</th><th>EIN</th><th>Deceased Name</th><th>DOE</th><th>Application No.</th><th>Submitted Date</th><th>Application Name</th><th>Sent By</th><th>Currently With</th><th>Remarks</th><th>Description</th><th>status</th></tr></thead>");
        ...
        submittedApplicantNames.forEach(function(submittedapplicant, index) {
            ...
            printWindow.document.write("<td>" + submittedapplicant.data11 + "</td>");
            printWindow.document.write("<td>" + submittedapplicant.data12 + "</td>");
