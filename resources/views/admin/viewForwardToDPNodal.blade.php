            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <form class="form-inline" id="ddoAststartEmpSearchBox" method="POST" action="{{ url('ddo-assist/viewForwardToDPNodalSearch') }}" enctype="multipart/form-data" class="was-validated">
                ...
                <div class="card-body">
                    ...
                    <b class="color">List of applicants for giving appointment approval:</b>
                    <hr>
                    <p>
                        ...
                        <tr>
                            ...
                            <tbody>
                                ...
                                <td class="rightstyle">
                                    ...
                                    $temp_array['appl_no'] = $appl_no;
                                    @endphp
                                    <button class="btn btn-danger btn-sm borderradius" role="button" aria-disabled="true"  id="edit_emp_name_btn" type="button" onclick='setForwardData(<?= json_encode($temp_array) ?>)'>Forward to DP Assistant</button>




                                    <a href="{{ route('discard-started-employee', Crypt::encryptString($data->ein)) }}" class="btn btn-danger btn-sm borderradius"  role="button" aria-disabled="true" onclick="return confirm('Are You Sure to Discard this Applicant?')">Reject</a>
                                    ...
                                    <form name="revertForm" action="{{ route('revertDetailsFromADNodal', Crypt::encryptString($data->ein)) }}" method="Post">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <label for="remark"><b>Any Description  (Less than 250 words)</b></label>
