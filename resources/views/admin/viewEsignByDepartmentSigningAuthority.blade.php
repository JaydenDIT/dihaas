        ...
        <div class="col-md-12">
            <div class="card">
                <!-- <div class="card-header"> -->
                    <!-- <form method="POST" action="{{ route('viewEsignByDeputySecretaryDeptSelect') }}">
                        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-5">
                            <form class="form-inline" id="ddoAststartEmpSearchBox" method="POST"
                                action="{{ url('/viewEsignByDepartmentSigningAuthoritySearch') }}"
                            ...
                            <table class="table table-bordered table-condensed table-striped" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($data->formSubStat == "Signed by DP")

                                        <td class="textright">
                                            <a href="{{ route('viewOrder', Crypt::encryptString($data->ein)) }}"
                                                class="btn btn-success font_size btnwidth" role="button"
                                                aria-disabled="true" target="_blank">e-Sign</a>
