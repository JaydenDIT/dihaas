        ...
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row container mt-3">
                        ...
                        <div class="col-6">
                            <form class="form-inline" id="ddoAststartEmpSearchBox" method="POST"
                                action="{{ url('ddo-assist/viewForwardToADAssistSearch') }}"
                ...
                <div class="card-body">
                    ...
                    <b class="color">List of applicantions submitted:</b>
                    ...
                    <div class="row">
                        ...
                        @else
                        <a href="{{ route('viewForwardToADAssist.downloadPDFApplView') }}" class="btn btn-success"
                        ...
                        <table class="table">
                            <thead class="">
                                ...
                                <th scope="col">Select</th>
                                    ...
                                    <th scope="col" colspan="5" class="textcenter">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(empty($empListArray))
                                ...
                                <tr>
                                    <td>
                                         <input type="checkbox" class="ein-checkbox" name="selected_ein[]"
                                            value="{{$data->ein}}">
                                    ...
                                    <!-- <td>
                                        ...
                                        <button type="button" class="btn btn-danger  btn-sm width openModalSingle"
                                            disabled>
                                            Forward to AD Nodal Officer
                                        </button>
                                        @else
                                ...
                                <div class="modal fade" id="remarkModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form name="revertForm"
                                            action="{{ route('revertDetailsFromADAsistant', Crypt::encryptString($data->ein)) }}"
                                            method="Post">
                                            @csrf
                                            <!-- @method('GET') -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" placeholder="Remark" class="form-control"
                                                        id="remark_data" name="remark" value="">
                                ...
                                <div class="modal fade" id="remarkForwardModal" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form name="forwardForm"
                                            action="{{ route('forwardDetailsFromADToADNodal', Crypt::encryptString($data->ein)) }}"
                                            method="Post">
                                            @csrf
                                            <!-- @method('GET') -->
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <input type="text" placeholder="efileAD" class="form-control"
                                                        id="efile_ad" name="efile_ad" value="" required>
                                                    <br>
                                                    <label for="ad_efile_link"><b>Browse eFile:</b></label>

                                                    <input type="file" class="form-control" id="ad_efile_link"
                                                        name="ad_efile_link" accept="application/pdf" value="" required>
                                ...
                                <div class="modal fade" id="remarkForwardModal_Checked" tabindex="-1"
                                    aria-labelledby="remarkForwardModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ route('forwardSelectedEINs') }}" method="post"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('removeBtn').addEventListener('click', function() {
        // Clear file input
        document.getElementById('ad_efile_link').value = '';
    });
});
</script>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.open-modal', function() {
        var selectedEIN = $('input[name="selected_ein[]"]:checked').val();
...
$(document).ready(function() {
    ...
    $(document).on('click', '.open-modal', function() {
        ...
        if (selectedEIN) {
            $('#modalSelectedEIN').val(selectedEIN); // Assuming you have an input field with the ID 'modalSelectedEIN'
            $('#remarkForwardModal_Checked').modal('show');
        } else {
            alert('Please select an EIN before opening the modal.');
        }
