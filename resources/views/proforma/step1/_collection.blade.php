 <form action="#" name="proforma-step1" id="proforma-step1">
     ...
     <div class="row bg-light border rounded p-3 mt-3">
         ...
         @include('proforma.step1._4applicant_address_current');
         @include('proforma.step1._5applicant_address_permanent');
         @include('proforma.step1._6prefer_post_parent_department');
         @include('proforma.step1._7prefer_post_other_department');
