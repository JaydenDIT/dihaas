...
<div class="row col-sm-6 mb-2 ps-5">
    ...
    <div>
        <input type="text" name="deceased_emp_name" id="deceased_emp_name" placeholder="Employee Name" class="form-control is_name"
            value="{{ $proforma->deceased_emp_name ?? '' }}"
...
<div class="row col-sm-6 mb-2 ps-5">
    ...
    <div>
        <input type="hidden" name="deceased_desig_cd" id="deceased_desig_cd" value="{{ $proforma->deceased_desig_cd ?? '' }}" />
...
<div class="row col-sm-6 mb-2 ps-5">
    ...
    <div>
        <input type="hidden" name="deceased_adm_dept_cd" id="deceased_adm_dept_cd" value="{{ $proforma->deceased_adm_dept_cd ?? '' }}" />
        <input type="text" name="deceased_adm_dept_desc" id="deceased_adm_dept_desc" placeholder="Administrative Department's Name"
            class="form-control is_name" maxlength="75" value="{{ $proforma->deceased_adm_dept_desc ?? '' }}" required>
        <div class="invalid-feedback" role="alert">
            This field is required.
        </div>
    </div>
...
<div class="row col-sm-6 mb-2 ps-5">
    ...
    <div>
        <input type="hidden" name="deceased_field_dept_cd" id="deceased_field_dept_cd" value="{{ $proforma->deceased_field_dept_cd ?? '' }}" />
        <input type="text" name="deceased_field_dept_desc" id="deceased_field_dept_desc" placeholder="Department Name" class="form-control is_address"
            value="{{ $proforma->deceased_field_dept_desc ?? '' }}"
            maxlength="75" required>
        <div class="invalid-feedback" role="alert">
            This field is required.
        </div>
...
<div class="row col-sm-6 mb-2 ps-5">
    ...
    <div>
        <input type="text" name="deceased_emp_group" id="deceased_emp_group" placeholder="Grade/Group"
            value="{{ $proforma->deceased_emp_group ?? '' }}"
