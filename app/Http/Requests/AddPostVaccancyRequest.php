...
class AddPostVaccancyRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'adm_dept_cd.required' => 'Please select an administrative department.',
            'field_dept_cd.required' => 'Please select a field department.',
