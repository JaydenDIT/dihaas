...
$(document).ready(function() {
  ...
  //While saving data
    ...
    $('#confirmSubmit').on('click', function() {
        ...
        $.ajax({
            ...
            url: "/ddo-assist/save-proforma-details2ndAppl", // Update the route to match your Laravel route
            data: formData,
            success: function(response) {
                ...
                // window.location.href = '/ddo-assist/update_second_applicant_data';
  ...
  $("#cancelBtn").click(function(e) {
    ...
    //console.log(ein);
    $.ajax({
      url: '/delete2ndAppl/' + ein, // replace ein with the actual value
      type: 'DELETE',
      headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
      success: function(response) {
        ...
        alert(response.message);
        window.location.href = '/ddo-assist/viewchangeApplicant';
      },
      error: function(xhr) {
