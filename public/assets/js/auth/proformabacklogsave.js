        ...
        if(einValue !== ''){
          $.ajax({
              ...
              success: function(response) {
                  if (response.exists) {
                      $('.error').html('<div class="alert alert-danger"><b>This EIN is already entered in the DIHAS database</b></div>');                   
                  } else {
                    var ein = document.getElementById('ein').value;
                    document.descriptiveRoleForm.action = "enterBacklogDetails";
  ...
  //While saving data
    ...
    $('#confirmSubmit').on('click', function() {
        ...
        $.ajax({
            ...
            url: "/ddo-assist/save-proforma-details-backlog", // Update the route to match your Laravel route
            data: formData,
            success: function(response) {
